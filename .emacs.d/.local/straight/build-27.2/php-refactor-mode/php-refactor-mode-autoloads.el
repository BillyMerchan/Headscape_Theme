;;; php-refactor-mode-autoloads.el --- automatically extracted autoloads
;;
;;; Code:
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "php-refactor-mode" '("php-refactor-")))
